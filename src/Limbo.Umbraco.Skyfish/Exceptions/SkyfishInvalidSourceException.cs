...
/// </summary>
public class SkyfishInvalidSourceException : SkyfishException {
    ...
    public SkyfishInvalidSourceException(string source) : base("Source doesn't match a valid URL or embed code.") {
        Source = source;
    }
